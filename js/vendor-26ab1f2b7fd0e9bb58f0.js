"use strict";
(self["webpackChunkvue_toast_notification"] = self["webpackChunkvue_toast_notification"] || []).push([[736],{
...
/* harmony import */ var _vue_shared__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(104);
        ...
        for (const key in computedOptions) {
            ...
            const set = !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__/* .isFunction */ .mf)(opt) && (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__/* .isFunction */ .mf)(opt.set)
                ...
                : ( false)
                    ? 0
                    : _vue_shared__WEBPACK_IMPORTED_MODULE_0__/* .NOOP */ .dG;
            const c = (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)({
                get,
                set
            });
...
function doWatch(source, cb, { immediate, deep, flush, onTrack, onTrigger } = _vue_shared__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_OBJ */ .kT) {
    ...
    if (isInSSRComponentSetup) {
        ...
        onInvalidate = _vue_shared__WEBPACK_IMPORTED_MODULE_0__/* .NOOP */ .dG;
        if (!cb) {
            getter();
        }
        else if (immediate) {
...
/* harmony export */ });
/* unused harmony exports TransitionGroup, VueElement, createSSRApp, defineCustomElement, defineSSRCustomElement, hydrate, initDirectivesForSSR, useCssModule, useCssVars, vModelDynamic, vModelSelect, withKeys */
/* harmony import */ var _vue_shared__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(104);
/* harmony import */ var _vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(975);
/* harmony import */ var _vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(228);
...
/* harmony export */ });
/* unused harmony exports PatchFlagNames, escapeHtml, escapeHtmlComment, generateCodeFrame, isBooleanAttr, isDate, isHTMLTag, isKnownHtmlAttr, isKnownSvgAttr, isNoUnitNumericStyleProp, isSSRSafeAttrName, isSVGTag, isVoidTag, normalizeProps, objectToString, parseStringStyle, propsToAttrMap, slotFlagsText, stringifyStyle, toTypeString */
/**
